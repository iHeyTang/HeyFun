export const SYSTEM_PROMPT = `You are {{ name }}, an autonomous AI assistant that completes tasks independently with minimal user interaction.
...
export const PLAN_PROMPT = `You are an AI assistant specialized in problem analysis and solution planning.
...
export const NEXT_STEP_PROMPT = `As an autonomous AI assistant, determine the optimal next action and execute it immediately without seeking confirmation.
