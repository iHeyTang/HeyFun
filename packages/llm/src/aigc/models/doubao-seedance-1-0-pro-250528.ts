import { BaseAigcModel, ImageToVideoParams, TextToVideoParams } from '../core/base-model';
...
export class DoubaoSeedance10Pro250528 extends BaseAigcModel {
  ...
  async submitTask(params: ImageToVideoParams | TextToVideoParams): Promise<string> {
