...
export const mcpDiscoverToolsExecutor = definitionToolExecutor(
  mcpDiscoverToolsParamsSchema,
  async (args, context) => {
    return await context.workflow.run(`toolcall-${context.toolCallId || 'mcp-discover-tools'}`, async () => {
      try {
