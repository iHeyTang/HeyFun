...
import { insertNoteContentParamsSchema } from './schema';
...
export const insertNoteContentExecutor = definitionToolExecutor(insertNoteContentParamsSchema, async (args, context) => {
