...
// 创建 FlowCanvas 项目
export const createFlowCanvasProject = withUserAuth(
  'flowcanvas/createFlowCanvasProject',
  async ({ orgId, args }: AuthWrapperContext<{ name: string; schema?: any }>) => {
...
// 获取 FlowCanvas 项目列表
export const getFlowCanvasProjects = withUserAuth(
  'flowcanvas/getFlowCanvasProjects',
...
// 获取单个 FlowCanvas 项目
export const getFlowCanvasProject = withUserAuth(
  'flowcanvas/getFlowCanvasProject',
  async ({ orgId, args }: AuthWrapperContext<{ projectId: string }>) => {
...
export const updateFlowCanvasProject = withUserAuth(
  'flowcanvas/updateFlowCanvasProject',
...
// 删除 FlowCanvas 项目
export const deleteFlowCanvasProject = withUserAuth(
  'flowcanvas/deleteFlowCanvasProject',
  async ({ orgId, args }: AuthWrapperContext<{ projectId: string }>) => {
    const { projectId } = args;
